...
> The R package remains the authoritative implementation; validate results
> against it before relying on a port for published work.
...
> **Experimental.** Validate results against the R package before relying on it
> for published work.
...
> **Experimental.** `@seminr/extras` is in early development (`0.x`) — validate
